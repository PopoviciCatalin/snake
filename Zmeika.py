...
def update_game_state(events, game_state):
    ...
    if game_state["game_running"] and not game_state["game_paused"]:
        ...
        check_apples_consumptions(game_state)
...
def check_key_presses(events, game_state):
    if "quit" in events:
        ...
        if "esc" in events or "space" in events:
...
def check_apples_consumptions(game_state):
    apples_eaten = 0
...
def update_screen(screen, game_state):
    ...
    if not game_state["game_running"]:
        print_new_game_mesage(screen)
    elif game_state["game_paused"]:
        print_game_paused_mesage(screen)
    else:
...
def print_new_game_mesage(screen):
    pass
def print_game_paused_mesage(screen):
    pass
...
def draw_walls(screen):
    ...
    pygame.draw.rect(screen, WALL_COLOR, ((0, 0), (WALL_SIZE, HEIGTH)))
    pygame.draw.rect(screen, WALL_COLOR, ((0, HEIGTH - WALL_SIZE), (WIDTH, HEIGTH)))
    pygame.draw.rect(screen, WALL_COLOR, ((WIDTH - WALL_SIZE, 0), (WIDTH, HEIGTH)))
